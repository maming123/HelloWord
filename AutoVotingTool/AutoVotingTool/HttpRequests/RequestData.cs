...
namespace DMedia.FetionActivity.Module.Utils
{
    public class RequestData
    {
        ...
        private string accept = "application/x-ms-application, image/jpeg, application/xaml+xml,image/png, image/x-xbitmap, image/jpeg, image/gif, image/pjpeg, application/x-ms-xbap, application/vnd.ms-excel, application/vnd.ms-powerpoint, application/msword, */*";
